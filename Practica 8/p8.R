...
stopCluster(cluster)
#plot(y= tiempos.secuencial_a, pch = 5, x = c(1, 2, 3, 4, 5), xlab = "cantidad extra de cúmulos y particulas", ylab = "tiempos")
#points(y = tiempos.paralelo_a, pch= 10, x = c(1, 2, 3, 4, 5))
#lines(y= tiempos.secuencial_a, x = c(1, 2, 3, 4, 5), col= "red")
#lines(y= tiempos.paralelo_a, x = c(1, 2, 3, 4, 5), col= "blue")
#legend(y= 120, x= 1, c("Secuencial", "Paralelo"), col = c("red", "blue"), cex = 1, lwd= 2, bty= "n")